...
(function() {
    ...
    function DeleteCurrentLots(){
        ...
        var deleted = 0;
        var total = $J('#tabContentsMyActiveMarketListingsTable').find('div.market_listing_cancel_button').length;
        ...
        $J('#tabContentsMyActiveMarketListingsTable').find('div.market_listing_cancel_button').each(function(i, el){
